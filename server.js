...
const PUBLIC_FILES=new Set(['/styles.css','/polish.css','/teacher-polish.css','/core.js','/admin.js','/admin-enhancements.js','/admin-v2.js','/teacher.js','/student.js','/history.js','/logo.png','/logo.svg']);
