...
const PUBLIC_FILES=new Set(['/styles.css','/polish.css','/teacher-polish.css','/theme.css','/core.js','/admin.js','/admin-enhancements.js','/admin-v2.js','/admin-course-tools.js','/teacher.js','/teacher-calendar.js','/student.js','/student-attendance.js','/history.js','/attendance.js','/preview-sync.js','/theme.js','/logo.png','/logo.svg']);
