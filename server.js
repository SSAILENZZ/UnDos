...
const PUBLIC_FILES=new Set(['/styles.css','/polish.css','/teacher-polish.css','/theme.css','/core.js','/admin.js','/admin-enhancements.js','/admin-v2.js','/admin-course-tools.js','/admin-statistics.js','/admin-promotion.js','/admin-audit.js','/admin-global-search.js','/exports.js','/notifications.js','/dashboard.js','/nav-observer-guard.js','/review-fixes.js','/mobile-fixes.js','/calendar-router-fix.js','/home-experience.js','/interaction-refinements.js','/community-refinements.js','/workspace-polish.js','/workflow-polish.js','/final-consistency.js','/stability-sweep.js','/nav-final.js','/post-review-fixes.js','/navigation-layout-fixes.js','/teacher.js','/teacher-calendar.js','/teacher-planning.js','/student.js','/student-attendance.js','/student-calendar.js','/student-home-smart.js','/student-profile.js','/communications.js','/visual-fixes.js','/history.js','/attendance.js','/preview-sync.js','/theme.js','/logo.png','/logo.svg']);
...
app.get('/favicon.ico',(_req,res)=>{res.setHeader('Cache-Control','public, max-age=86400');res.type('png').sendFile(path.join(__dirname,'logo.png'))});
