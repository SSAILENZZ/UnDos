...
const PUBLIC_FILES=new Set(['/styles.css','/polish.css','/teacher-polish.css','/theme.css','/core.js','/admin.js','/admin-enhancements.js','/admin-v2.js','/admin-course-tools.js','/admin-statistics.js','/admin-promotion.js','/admin-audit.js','/admin-global-search.js','/exports.js','/teacher.js','/teacher-calendar.js','/teacher-planning.js','/student.js','/student-attendance.js','/student-calendar.js','/student-home-smart.js','/student-profile.js','/communications.js','/visual-fixes.js','/history.js','/attendance.js','/preview-sync.js','/theme.js','/logo.png','/logo.svg']);
